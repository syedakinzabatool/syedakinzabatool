...
- NumPy, Pandas, Matplotlib, and Seaborn for analysis and visualization
- Streamlit for lightweight interactive apps and demos
- Git, Linux, Jupyter, VS Code, and Google Colab for day-to-day development
